...
<s:form action="/manage/appCommon!saveAboutus.action" id="form" name="form" theme="simple" method="post">
	<table class="table table-bordered">
        ...
        <tr>
          ...
          <td style="text-align: left;" colspan="3"><s:textfield theme="simple" name="pcaboutus.title" id="title" readonly="false"/></td>
		  <td class="td_right" style="display: none;">分站</td>
          <td style="text-align: left;display: none;">
                <select name="pcaboutus.substation" id="substation">
