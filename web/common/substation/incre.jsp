...
<head lang="en">
	...
	<style type="text/css">.fixed{top:auto;bottom:10%!important;}</style>
</head>
<body>
<%@ include file="../../header.jsp"%>
<div class="ycdata_bgimg">
	<a href="${incretopimg.url }" target="_black"><img id="incretopimg" src="${incretopimg.image }"></a>
</div>
...
<script>
	$('#incretopimg').error(function(){
	    $(this).attr('src', "/image/box/zjbanner.jpg?${sysversion}");
