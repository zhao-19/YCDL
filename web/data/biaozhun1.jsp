...
<div class="ycdata_center">
	    ...
	    <s:iterator value="pager.list">
   			<div class="ycdata_list1 widthbox fl">
				<div class="data_list_name1 fl">
 					<li class="data_list_name_info1 fl"> <s:property value="qiyemingcheng"/>  <br><div class="xiamian1 fl"> </div></li>
				</div>
				<div class="data_list_scale1 fl">
					<li><s:property value="gszcd_city"/> &nbsp; <s:property value="biaozhunmingcheng"/>   </li> 
				</div>
				<div class="data_list_profession1 fl">
					<li><s:property value="xingzhi"/> </li>
				</div>
				<div class="data_list_profession2 fl">
					<li> <s:property value="zhiwu"/></li>
				</div>
			</div>
		</s:iterator>
		</div>
 ...
 <script>
    ...
    function queryData(){
    	...
    	var _url = "/data/toBiaozhun1List2.html?page="+queryDataCount;
//	alert(_url);
		$.ajax({
		  type: 'POST',
		  url: _url,
		  ...
		  success: function(data){
			  ...
			  for(var i=0;i<data.length;i++ ){  
 			    ...
 			    _content.push(
			    	"<div class=\"ycdata_list1 widthbox fl\">"+
					"<div class=\"data_list_name1 fl\">"+
						"<li class=\"data_list_name_info1 fl\"><a href='#'>"+data[i].qiyemingcheng+"</a><br><div class=\"xiamian1 fl\"> </div></li>"+
					"</div>"+
					"<div class=\"data_list_scale1 fl\">"+
						"<li>"+data[i].biaozhunmingcheng+"</li>"+
					"</div>"+
					"<div class=\"data_list_profession1 fl\">"+
						"<li>"+data[i].xingzhi+"</li>"+
					"</div>"+
					"<div class=\"data_list_profession2 fl\">"+
						"<li>"+data[i].zhiwu+"</li>"+
					"</div>"+
...
function doquery(){
    var query = $('#contentquery').val();
 	if(query=='') {
		...
		var url = '/data/toBiaozhun1List.html?t=q&q='+query;
 		window.location = url;
		return ;
	}
 }
...
.ycdata_title .data_title_head .scale {width: 30%;border-left: 1px solid #EBEBEB;}
.ycdata_title .data_title_head .profession {border-left: 1px solid #EBEBEB;}
...
.ycdata_list1 .data_list_scale1 {width: 30%;line-height: normal;line-height: normal;padding-top: 20px;border-left: 1px solid #EBEBEB;}
.ycdata_list1 .data_list_profession1 {border-left: 1px solid #EBEBEB;}
.ycdata_list1 .data_list_profession2 {line-height: 105px;height: 105px;border: 0px solid #000;color: #E84C3D;width: 20%;border-left: 1px solid #EBEBEB;border-right: 1px solid #EBEBEB;}
