...
<div class="ycdata_center">
	    ...
	    <s:iterator value="pager.list">
   			<div class="ycdata_list1 widthbox fl">
				...
				<div class="data_list_profession1 fl">
					<li><s:property value="zengxinquanzhong"/> </li>
				</div>
				<div class="data_list_profession2 fl">
					<li> <s:property value="shouxinedu"/></li>
				</div>
			</div>
		</s:iterator>
		</div>
 ...
 <script>
    ...
    function queryData(){
    	...
    	var _url = "/data/toBiaozhun3List2.html?page="+queryDataCount;
//	alert(_url);
		$.ajax({
		  type: 'POST',
		  url: _url,
		  ...
		  success: function(data){
			  ...
			  for(var i=0;i<data.length;i++ ){  
 			    ...
 			    _content.push(
					...
					"</div>"+
					"<div class=\"data_list_profession1 fl\">"+
						"<li>"+data[i].zengxinquanzhong+"</li>"+
					"</div>"+
					"<div class=\"data_list_profession2 fl\">"+
						"<li>"+data[i].shouxinedu+"</li>"+
					"</div>"+
				"</div>"
				);
		  } 
...
function doquery(){
    var query = $('#contentquery').val();
 	if(query=='') {
		...
		var url = '/data/toBiaozhun3List.html?t=q&q='+query;
 		window.location = url;
		return ;
	}
 }
...
.ycdata_list1 .data_list_scale1 {width: 30%;}

.ycdata_list1 .data_list_name1 {width: 30%;border-left: 1px solid #EBEBEB;}
.ycdata_list1 .data_list_scale1 {line-height: normal;padding-top: 20px;border-left: 1px solid #EBEBEB;}
