...
KindEditor.lang({
	...
	'baidumap.search' : '鎼滅储',
	'baidumap.insertDynamicMap' : '鎻掑叆鍔ㄦ�鍦板浘',
	'anchor.name' : '閿氱偣鍚嶇О',
...
KindEditor.plugin('map', function(K) {
	...
	self.clickToolbar(name, function() {
		...
		var iframeHtml = ['<!doctype html><html><head>',
			...
			'</body></html>'].join('\n');
		// TODO锛氱敤doc.write(iframeHtml)鏂瑰紡鍔犺浇鏃讹紝鍦↖E6涓婄涓�鍔犺浇鎶ラ敊锛屾殏鏃朵娇鐢╯rc鏂瑰紡
