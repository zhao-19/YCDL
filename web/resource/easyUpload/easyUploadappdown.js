    ...
    this.each(function (index, element) {
      ...
      var easyManager = {
        ...
        bindHead: function () {
          ...
          $('.easy_upload_select').click(function () {
          ...
          $('.easy_upload_head_btn1').click(function(){
          ...
          $('.easy_upload_head_btn2').click(function(){
            var queueUl = $(this).parent().parent().find('.easy_upload_queue');
        ...
        bindQueue: function () {
          ...
          $('.easy_upload_upbtn').click(function(){
          ...
          $('.easy_upload_delbtn').click(function(){
...
$('body').delegate('.uploadbtn','click',function () {
    ...
    if(reg=="image"){
        ...
        allowFileTypes='*.jpg;*.jpeg;*.png;*.bmp;';
        accept='.jpg,.jpeg,.png,.bmp';
    }else if(reg=="mps"){
        note='提示：支持格式为mp3、mp4。';
        allowFileTypes='*.mp3;*.mp4;';
        accept='.mp3,.mp4';
    }else if(reg=="mp4"){
        note='提示：支持格式为mp4。';
        allowFileTypes='*.mp4;';
    ...
    $('#uploadbox').easyUpload({
        ...
        successFunc: function (res) {
            var imglink=thisbtn.prev('div').find('img');
            if(reg=="image"){
                imglink.attr('src',res.data.file1);
                if(type=="iostest"){
                    $('#iostesttime').html(new Date().Format("yyyy-MM-dd HH:mm:ss"));
                }else{
                    $('#iosadmintime').html(new Date().Format("yyyy-MM-dd HH:mm:ss"));
                }
            }else if(reg=="apk"){
              if(type=="androidtest"){
                  $('#androidtest').html("");
                  new QRCode(document.getElementById("androidtest"),res.data.file1);
                  $('#androidtesttime').html(new Date().Format("yyyy-MM-dd HH:mm:ss"));
              }else{
                  $('#androidadmin').html("");
                  new QRCode(document.getElementById("androidadmin"),res.data.file1);
                  $('#androidadmintime').html(new Date().Format("yyyy-MM-dd HH:mm:ss"));
