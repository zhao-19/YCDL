    ...
    c.events = function() {
        ...
        c.each(b("#laydate_table td"), function(a, b) {
            c.on(b, "click", function(a) {
                ...
                //这里是点击选z
                $("#ifchange").val(this.getAttribute("d")).change();
                //这里是选择了弹框中的日期，并且关闭弹框之后。
                $(".laydate-icon").parent().children("span").html("");//这里是配合checkEachNeedDate这个函数，把提示关闭
