...
;(function (factory) {
    ...
    Indicator.prototype = {
        ...
        value: function(val) {
            ...
            ctx.beginPath();
            ctx.lineWidth = indOption.barWidth+6;
            ctx.arc(center, center, indOption.radius - 1 + indOption.barWidth / 2, -(quart), ((circ) * perVal / 75) - quart, false);
            ctx.stroke();
...
//setTimeout(radialObj8.animate(75000),10);
