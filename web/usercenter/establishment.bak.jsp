...
<div class="operate">
	...
	<div class="list fr">
		...
		<form id="qyxxform" action="" method="post">
			...
			<!-- 债权信息    用户为企业时显示    -->
			<div id="zaiquanxinxi" class="vipinfo" >
				...
				<table id="TBzq" align="center" border="0" cellpadding="0" cellspacing="1">
					...
					<tr>
						...
						<td>3333333</td>
						<td>3333333</td>						
						<td><input  class="op  opl"  lang="<s:property value="id"/>"    type="button" value="修改" class="pxhdjs"><input class="op opr"  type="button" value="取消报名"   lang="<s:property value="id"/>"  ></td>
					</tr>
