	...
	<div class="list fr">
		<div class="rightbox">
			<div id="zaiquanxinxi-update" class="vipinfo" >
				<div class="title"><li><span class="t">券商期货数据报送</span><a href="/userextend/getQsqhinfo.html?t=a" id="addA"><span class="update">添加</span></a></li>
				</div>
					...
					<tbody>
 					<s:iterator value="tbjrqsqhList">
						<tr>
			                ...
			                <td>
				                <input type="button" value="查看" class="an ck op opr" onclick="$('#hideA').attr('href','/userextend/getQsqhinfo.html?t=v&queryid=${id}')[0].click();"/>
				                <s:if test="status=='aaaaaaaaaaaaaaaaaaaaaaaaaaaaa080'"><input type="button" value="修改" class="an xg op opl" onclick="$('#hideA').attr('href','/userextend/getQsqhinfo.html?queryid=${id}')[0].click();"/></s:if>
			                </td>
						</tr>
					</s:iterator>
					</tbody>
