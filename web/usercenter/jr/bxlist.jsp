	...
	<div class="list fr">
		<div class="rightbox">
			<div id="zaiquanxinxi-update" class="vipinfo" >
				<div class="title"><li><span class="t">保险公司数据报送</span><a href="/userextend/getBxinfo.html?t=a" id="addA"><span class="update">添加</span></a></li>
				</div>
				<table id="ycacti" align="center" border="0" cellpadding="0" cellspacing="1">
					...
					<tbody>
 					<s:iterator value="tbjrbxList">
						<tr>
			                <td>&nbsp;${time_port }</td>
			                <td>&nbsp;${insurance_income }</td>
			                ...
			                <td>
				                <input class="an ck op opr" type="button" value="查看" onclick="$('#hideA').attr('href','/userextend/getBxinfo.html?t=v&queryid=${id}')[0].click();"/>
				                <s:if test="status=='aaaaaaaaaaaaaaaaaaaaaaaaaaaaa080'">
				                	<input type="button" value="修改" class="an xg op opl" onclick="$('#hideA').attr('href','/userextend/getBxinfo.html?queryid=${id}')[0].click();"/>
				                </s:if>
			                </td>
						</tr>
					</s:iterator>
