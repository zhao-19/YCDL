...
<head lang="en">
   <script>
	...
	<script type="text/javascript" src="<%=SystemManager.CONFIGS.get(Config.BANBENHAO_KEY) %>/js/jquery-1.4.2.min.js"></script>
	<script type="text/javascript" src="<%=SystemManager.CONFIGS.get(Config.BANBENHAO_KEY) %>/js/jquery.validate-1.13.1.js"></script>
	<script type="text/javascript" src="<%=SystemManager.CONFIGS.get(Config.BANBENHAO_KEY) %>/js/fbrzxq.js"></script>
...
<!--app上线提示弹窗开始 取消注释可用-->
	...
	<!--中介活动弹窗-->
	 <!--<div class="indexPop">-->
		<!--<div id="popbanner"></div>-->
		<!--<div id="popbannerimg" style="width: 43%;">-->
			<!--&lt;!&ndash;<span id="apppopclose" class="apppopclose" style="top:-3%;right:-3%";>&ndash;&gt;-->
				<!--&lt;!&ndash;<img src="<%=SystemManager.CONFIGS.get(Config.BANBENHAO_KEY)%>/image/index/popzjclose.png" alt="">&ndash;&gt;-->
			<!--&lt;!&ndash;</span>&ndash;&gt;-->
			<!--<a href="/park/settedIn.jsp" target="_blank"><img src="<%=SystemManager.CONFIGS.get(Config.BANBENHAO_KEY)%>/image/index/pop_settedIn.png" alt=""></a>-->
			<!--<span id="waittime" class="apppopclose" style="right:1.5%;left:auto;top:2%;"><i>5</i>秒后自动关闭</span>-->
		<!--</div>-->
		<!--&lt;!&ndash;<img src="<%=SystemManager.CONFIGS.get(Config.BANBENHAO_KEY)%>/image/index/popzjsmall.png" alt="" id="poperwm" style="width: 11%; top:72%;">&ndash;&gt;-->
	<!--</div>-->
	<!--app上线提示弹窗结束-->
	 <script>
        $().ready(function(){
				...
				<div class="threeBox">
					...
					<div class="tong">
						...
						<div class="inputrow inputrow2">
							<span>申请企业名称<i class="require">*</i></span>
							<div>
						...
						<div class="inputrow inputrow2">
							<span>社会信用代码<i class="require">*</i></span>
							<div>
						...
						<div style="overflow: hidden; width: 100%;">
							<div class="inputrow">
								...
								<div>
									<input isNotNull="成立日期" type="text" name="regdate"  id="maxDate" class="laydate-icon"  value="" >
									<span class="error"></span>
								</div>
							</div>
							<div class="inputrow jine">
								<span>注册资本(万元)<i class="require">*</i></span>
								<div>
						...
						<div style="overflow: hidden; width: 100%;">
							<div class="inputrow">
								<span>法定代表人<i class="require">*</i></span>
								<div>
							...
							<div class="inputrow">
								<span>联系人<i class="require">*</i></span>
								<div>
						...
						<div class="inputrow inputrow2">
							<span>注册地址<i class="require">*</i></span>
							<div>
						...
						<div class="inputrow inputrow2">
							<span>主营业务<i class="require">*</i></span>
							<div>
						...
						<div class="zmtbox">
							<div class="zmtStep">
								<h1>二、业务情况（进出口量/年）</h1>
								<div class="inputrow">
									<span style="font-size: 13px;">货物贸易(万美元)<i class="require">*</i></span>
									<div>
								...
								<div class="inputrow">
									<span style="font-size: 13px;">服务贸易(万美元)<i class="require">*</i></span>
									<div>
					...
					<!--科票通-->
					<div class="kpt">
						<input type="text" name="loanname" value="科票通" id="loanname" style="display: none;">
						<h1>一、基本情况</h1>
						<div class="inputrow inputrow2">
							<span>申请企业名称<i class="require">*</i></span>
							<div>
						...
						<div class="kptbox1">
							<div class="kptStep">
								<div class="inputrow inputrow2">
									<span>所属行业<i class="require">*</i></span>
									<div>
								...
								<div class="inputrow">
									<span style="font-size: 13px;">是否高新技术企业<i class="require">*</i></span>
									<div>
								...
								<div class="inputrow">
									<span>获得发明专利件数<i class="require">*</i></span>
									<div>
								...
								<div class="inputrow">
									<span>实用新型件数<i class="require">*</i></span>
									<div>
								...
								<div class="inputrow">
									<span>软件著作权件数<i class="require">*</i></span>
									<div>
						...
						<div class="kptbox2">
							<div class="kptStep2">
								<h1>二、申请贴现情况</h1>
								<div class="inputrow inputrow2">
									<span style="font-size: 13px;">申请贴现期限(月)<i class="require">*</i></span>
									<div>
								...
								<div class="inputrow">
									<span style="font-size: 13px;">申请贴现金额(万)<i class="require">*</i></span>
									<div>
					...
					<!--中小企业需求-->
					<div class="xuqiu">
						<input type="text" name="substation" value=""  style="display: none;">
						<div class="inputrow inputrow2">
	...
	<script>
		...
		var url;
        var xuqiu=$('.xuqiu').clone();
        var zmtAll=$('.tong').clone();
        var kptAll=$('.kpt').clone();
...
<div class="index_banner_box">
    ...
    <div class="focusBox">
		...
		<li><a href="/park/settedIn.jsp"><img src="<%=SystemManager.CONFIGS.get(Config.BANBENHAO_KEY) %>/image/index/banner_settedIn.jpg"></a></li>

			<!--<li><a href="#" class="zmtlink" onclick="productApply(1,'自贸通')"><img src="<%=SystemManager.CONFIGS.get(Config.BANBENHAO_KEY) %>/image/index/zmtbanner.jpg"></a></li>-->
...
<div class="info_content widthbox bgf boxsiz" style="margin-top:44px;"><!-- 信息内容 -->
		...
		String endtime  = a.getEndtime();
        	...
        	if(i==0) {
             out.print("<a target=\"_blank\" href=\"collegedetail\\"+a.getId()+".html\"> <h3 class=\"cur\"  title=\""+a.getActivities_name()+"\" >"+AppUtil.substring(a.getActivities_name(), 28)+"<span class=\"new\">&nbsp;</span></h3></a>");
				 ...
				 out.print("<a target=\"_blank\" href=\"collegedetail\\"+a.getId()+".html\"> <h3 class=\"cur\"  title=\""+a.getActivities_name()+"\" >"+AppUtil.substring(a.getActivities_name(), 28)+"</h3></a>");
			}
...
<div class="middle_addwk" style="margin-bottom:44px;">
	<div class="middle_add">
		...
		<ul class="midUl ov">
			...
			<li class="trans3" onclick="productApply(1,'科票通')">
			...
			<li class="trans3"  onclick="productApply(2,'中小企业融资')">
