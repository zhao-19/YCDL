			...
			<% if(SystemManager.SBLIST!=null) {
							...
							<!-- 这是以前的逻辑 -->
											<s:if test="#request.msg == 'erro'">
												...
												<a href="javascript:msg.info('您已申报此补贴申请，不能重复申请同一个补贴！');">
													<span id="CreateTBpxhd" class="update">申报补贴</span> </a>
	
											</s:if>
											<s:else>
												<s:if test="#request.isBase == 1">
													<a
														href="/declare_btz/toFrontAdd.html?leibie=${leibie}&type=${type}&t=a">
														<span id="CreateTBpxhd" class="update">申报补贴</span> </a>
												</s:if>
												<s:else>
													<a href="javascript:void(0);"
														onclick='return myConfirm("你还未填写企业基本情况表，需先填写后才可申报！","立即填报","取消","/declare_btz/toFrontAdd.html?leibie=${leibie}&type=${type}");'>
														<span id="CreateTBpxhd" class="update">申报补贴</span> </a>
												</s:else>
											</s:else>
                    ...
                    <s:iterator value="#request.pager.list">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <%--<input class="an xzp op oprd"  type="button" value="" onclick="location.href='declare_btz/exportPDF.html?id=<s:property value="id"/>&type=hlwbt&leibie=1'"  title="导出pdf"  >--%>
                            	<input class="an xzw op oprd"  type="button" value="" msg="${type}"  title="导出申报资料"  lang="<s:property value="id"/>"  >
                ...
                <script type="text/javascript">
                    ...
                    opls.click(function () {
                        ...
                        location.href = "/declare_btz/toFrontEdit.html?id=" + id + "&type=${type}";
                    });
                    //查看
                    oprs.click(function () {

                        var id = $(this).attr("lang");
                        location.href = "/declare_btz/toFrontEdit.html?id=" + id + "&t=v" + "&type=${type}";
                    });
