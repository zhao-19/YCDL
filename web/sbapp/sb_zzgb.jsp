...
<head>
   ...
   <script language="javascript" type="text/javascript"
    ...
    <style type="text/css">
    	.creditor .vipinfo .inputtest .leftname.lpamk{width: 160px;}
    </style>
    ...
    $(window).load(function () {
        ...
        if (backnotice == 'success') {
            if(backnoticebzf=='1'){
	            ggts2("数据保存成功！");
	            setTimeout(function(){
	    			window.location="/declare_zzgb/selectAllList.html?type=zzgbbt&init=y";
	   			},1500);
		    }
		    if(backnoticebzf=='2'){
		    	ggts2("数据提交成功！");
    ...
    <div class="list fr">
        <div class="rightbox">
            ...
            <div id="zaiquanxinxi-update" class="vipinfo">
                ...
                <form id="form1" action="/declare_zzgb/saveData.html" method="post">
                    ...
                    <div class="inputtest inputtestl">
                        <span class="leftname leftnamel">转增股本金额：<span style="color:red">*</span></span>
                        <span class="rightinfo"><input isNotNull="转增股本金额" isBankZint="isBankZint" onchange="this.value=formatNum(this.value)" isLength="[0,18]" class="input ibg" id="zzgbje" name="zzgbje" type="text"
                                                       value="<s:property value='e.zzgbje'/>"/></span>
                    </div>
                    ...
                    <div class="inputtest inputtestl">
                        <span class="leftname leftnamel">股改时间：<span style="color:red">*</span></span>
                        <span class="rightinfo"><input class="input stext laydate-icon needDate" readonly="readonly" id="ggsj"
                                                       name="ggsj" type="text"
                                                       value="<s:property value='e.ggsj.substring(0,10)'/>"/></span>
                    </div>

                    <div class="inputtest inputtestl">
                        <span class="leftname leftnamel">转增股本时间：<span style="color:red">*</span></span>
                        <span class="rightinfo"><input class="input stext laydate-icon needDate" readonly="readonly" id="zzgbsj"
                                                       name="zzgbsj" type="text" value="<s:property value='e.zzgbsj.substring(0,10)'/>"/></span>
                    </div>
                    ...
                    <input id="xtjsje" lang="系统计算金额/建议支持金额" name="xtjsje" type="hidden"
						...
						<p class="jiange">转增股本明细</p>
						<div id="dkk">
							<c:if test="${fn:length(e.sbzzgbcoreList) > 0}">
								<c:forEach items="${e.sbzzgbcoreList}" var="datas"
									varStatus="status">
									<input type="hidden" name="sbzzgbcoreList[${status.index}].id" value="${datas.id}">
									<div class="xkk" lang="firsttr">
										<div class="inputtest inputtestl">
											<span class="leftname leftnamel ">申请人姓名：<span style="color:red">*</span></span>
											<span class="rightinfo"> <input isNotNull="申请人姓名" isLength="[1,32]"
												class="input inumber  gsgb" id="sbzzgbcoreList[${status.index}].appname"
												name="sbzzgbcoreList[${status.index}].appname" type="text" value="${datas.appname}" />
											</span>
										</div>

										<div class="inputtest inputtestl">
											<span class="leftname leftnamel lpamk">身份证号：<span style="color:red">*</span></span> <span class="rightinfo">
											<input isNotNull="身份证号" isLength="[0,18]" class="input inumber ptgb" id="sbzzgbcoreList[${status.index}].idcard"
												name="sbzzgbcoreList[${status.index}].idcard" type="text" value="${datas.idcard}" /></span>
										</div>

										<div class="inputtest inputtestl">
											<span class="leftname leftnamel ">担任职务：<span style="color:red">*</span></span> <span class="rightinfo ">
												<input isNotNull="担任职务" isLength="[1,32]" class="input inumber  yggb"
												id="sbzzgbcoreList[${status.index}].duty"
												name="sbzzgbcoreList[${status.index}].duty" type="text" value="${datas.duty}" /></span>
										</div>

										<div class="inputtest inputtestl">
											<span class="leftname leftnamel lpamk">个人转增股本金额(万)：<span style="color:red">*</span></span><span class="rightinfo ">
											<input isNotNull="个人转增股本金额（万元）" isBankZint="isBankZint" isLength="[1,18]"
												class="input inumber ptgb" id="sbzzgbcoreList[${status.index}].zzgbcount"
												name="sbzzgbcoreList[${status.index}].zzgbcount" type="text" value="${datas.zzgbcount}" /></span>
										</div>
										
										<div class="inputtest inputtestl">
											<span class="leftname leftnamel ">股份占比（%）：<span style="color:red">*</span></span> <span class="rightinfo ">
												<input isNotNull="股份占比（%）" isBankZint="isBankZint" isLength="[1,18]" class="input inumber  yggb"
												id="sbzzgbcoreList[${status.index}].stocks"
												name="sbzzgbcoreList[${status.index}].stocks" type="text" value="${datas.stocks}" /></span>
										</div>

										<div class="inputtest inputtestl">
											<span class="leftname leftnamel lpamk">缴纳个人所得税(万)：<span style="color:red">*</span></span><span class="rightinfo ">
											<input isNotNull="缴纳个人所得税（万元）" isBankZint="isBankZint" isLength="[1,18]"
												class="input inumber ptgb" id="sbzzgbcoreList[${status.index}].incometax"
												name="sbzzgbcoreList[${status.index}].incometax" type="text" value="${datas.incometax}" /></span>
										</div>
							...
							<c:if test="${fn:length(e.sbzzgbcoreList) <= 0}">
								<div class="xkk" lang="firsttr">
									...
									<div class="inputtest inputtestl">
											<span class="leftname leftnamel ">申请人姓名：<span style="color:red">*</span></span>
											<span class="rightinfo "> <input isNotNull="申请人姓名" isLength="[1,32]"
												class="input inumber  gsgb" id="sbzzgbcoreList[0].appname"
												name="sbzzgbcoreList[0].appname" type="text" value="" />
											</span>
										</div>

										<div class="inputtest inputtestl">
											<span class="leftname leftnamel lpamk">身份证号：<span style="color:red">*</span></span> <span class="rightinfo">
											<input isNotNull="身份证号" isLength="[0,18]" class="input inumber ptgb" id="sbzzgbcoreList[0].idcard"
												name="sbzzgbcoreList[0].idcard" type="text" value="" /></span>
										</div>

										<div class="inputtest inputtestl">
											<span class="leftname leftnamel ">担任职务：<span style="color:red">*</span></span> <span class="rightinfo ">
												<input isNotNull="担任职务" isLength="[1,32]" class="input inumber  yggb"
												id="sbzzgbcoreList[0].duty"
												name="sbzzgbcoreList[0].duty" type="text" value="" /></span>
										</div>

										<div class="inputtest inputtestl">
											<span class="leftname leftnamel lpamk">个人转增股本金额(万)：<span style="color:red">*</span></span><span class="rightinfo ">
											<input isNotNull="个人转增股本金额（万元）" isBankZint="isBankZint" isLength="[1,18]"
												class="input inumber ptgb" id="sbzzgbcoreList[0].zzgbcount"
												name="sbzzgbcoreList[0].zzgbcount" type="text" value="" /></span>
										</div>
										
										<div class="inputtest inputtestl">
											<span class="leftname leftnamel">股份占比（%）：<span style="color:red">*</span></span> <span class="rightinfo ">
												<input isNotNull="股份占比（%）" isBankZint="isBankZint" isLength="[1,18]" class="input inumber  yggb"
												id="sbzzgbcoreList[0].stocks"
												name="sbzzgbcoreList[0].stocks" type="text" value="" /></span>
										</div>

										<div class="inputtest inputtestl">
											<span class="leftname leftnamel lpamk">缴纳个人所得税(万)：<span style="color:red">*</span></span><span class="rightinfo ">
											<input isNotNull="缴纳个人所得税（万元）" isBankZint="isBankZint" isLength="[1,18]"
												class="input inumber ptgb" id="sbzzgbcoreList[0].incometax"
												name="sbzzgbcoreList[0].incometax" type="text" value="" /></span>
										</div>
                   ...
                   <!--  <p style="color:red;float: left;font-size: 20px;">说明：</p>
					
					<div style="color:red;float: left;padding:20px;box-sizing:border-box;S" class="xkk">
					转增股本项目，申请报告，落款需要公司公章和申请人的签字。然后项目内需要填的有：<br/>
						<img src="/image/zzgb.jpg"/>
					</div> -->
...
<script type="text/javascript">
    !function () {
        ...
        laydate({elem: '#ggsj'});//绑定元素
        laydate({elem: '#zzgbsj'});//绑定元素
    }();
    ...
    function deleteCore(obj, id) {
    	...
    	$("#delSure .delsure").click(function(){
			...
			if (objid != 0 && xkks.length>1) {
		            $.post('/declare_zzgb/deleteCore.html',{ id : objid }, function (data) {
