					...
					if("15".equals(sb.getId())) {
                        ...
                        <s:else>
                            <s:if test="#request.isBase == 1">
                                <a href="/declare_btz/toFrontAdd.html?leibie=${leibie}&type=${type}&t=a">
                                    <span id="CreateTBpxhd" class="update">申报补贴</span>
                                </a>
                            </s:if>
                            <s:else>
                                <a href="javascript:void(0);"
                                   onclick='return myConfirm("你还为填写企业基本情况表，需先填写后才可申报！","立即填报","取消","/declare_btz/toFrontAdd.html?leibie=${leibie}&type=${type}");'>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <input class="an ck op opr" type="button" value="" lang="<s:property value="id"/>">
                                    <%--<input class="an xzp op oprd"  type="button" value="" onclick="location.href='declare_btz/exportPDF.html?id=<s:property value="id"/>&leibie=2&type=kjcxbt'"  title="导出pdf"  >--%>
