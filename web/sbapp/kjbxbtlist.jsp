...
<% if(SystemManager.SBLIST!=null) {
					...
					if("13".equals(sb.getId())) {
                        ...
                        <s:else>
                            <s:if test="#request.isBase == 1">
                                <a href="/declare_kjbx/toFrontAdd.html?type=${type}&t=a">
                                    <span id="CreateTBpxhd" class="update">申报补贴</span>
                                </a>
                            </s:if>
                            <s:else>
                                <a href="javascript:void(0);"
                                   onclick='return myConfirm("你还为填写企业基本情况表，需先填写后才可申报！","立即填报","取消","/declare_kjbx/toFrontAdd.html?type=${type}");'>
                                    <span id="CreateTBpxhd" class="update">申报补贴</span>
                                </a>
                            </s:else>
                        </s:else>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <input class="an ck op opr" type="button" value="" lang="<s:property value="id"/>">
                                    <%--<input class="an xzp op oprd"  type="button" value="" onclick="location.href='declare_kjbx/exportPDF.html?id=<s:property value="id"/>'"  title="导出pdf"  >--%>
                ...
                <script type="text/javascript">
                    ...
                    opls.click(function () {
                        ...
                        location.href = "/declare_kjbx/toFrontEdit.html?id=" + id;
                    });
                    //查看
                    oprs.click(function () {

                        var id = $(this).attr("lang");
                        location.href = "/declare_kjbx/toFrontEdit.html?id=" + id + "&t=v";
                    });
