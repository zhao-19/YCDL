    ...
    $(window).load(function () {
        ...
        if (backnotice == 'success') {
            if(backnoticebzf=='1'){
	            ggts2("数据保存成功！");
	            setTimeout(function(){
	    			window.location="/declare_czbg/selectAllList.html?type=czbgbt&init=y";
	   			},1500);
		    }
		    if(backnoticebzf=='2'){
		    	ggts2("数据提交成功！");
    ...
    <div class="list fr">
        <div class="rightbox">
            ...
            <div id="zaiquanxinxi-update" class="vipinfo">
                ...
                <form id="form1" action="/declare_czbg/saveData.html" method="post">
                    ...
                    <div class="inputtest inputtestl">
                        <span class="leftname leftnamel">交易类型：<span style="color:red">*</span></span>
					<span class="rightinfo">
                        <select class="select" isNotNull="交易类型" readonly="readonly" name="sqfx" id="sqfx">
							<option value=""></option>
						<option value="并购" <c:if test="${e.sqfx == '并购'}">selected</c:if>>并购</option>
						<option value="被并购" <c:if test="${e.sqfx == '被并购'}">selected</c:if>>被并购</option>
						</select>
					</span>
                    </div>
 					    ...
 					    <div class="inputtest inputtestl">
                                    <span class="leftname leftnamel">交易时间：<span style="color:red">*</span></span>
                                <span class="rightinfo"><input class="input laydate-icon needDate"  
                                                               id="deal_time" name="deal_time"
                                                               type="text"
                                                               value="<s:property value='e.deal_time'/>"/></span>
                                </div>


                    <div class="inputtest inputtestl">
                        <span class="leftname leftnamel">交易对手企业名称：<span style="color:red">*</span></span>
                        <span class="rightinfo"><input isNotNull="企业名称" isLength="[0,16]"  class="input" id="bbgqymc" name="bbgqymc" type="text"
                                                       value="<s:property value='e.bbgqymc'/>"/></span>
                    </div>

                    <div class="inputtest inputtestl">
                        <span class="leftname leftnamel">交易金额：<span style="color:red">*</span></span>
                        <span class="rightinfo"><input isNotNull="交易金额" isBankZint="isBankZint" onchange="this.value=formatNum(this.value)" isLength="[0,18]" class="input ibg" id="jyje" name="jyje" type="text"
                                                       value="<s:property value='e.jyje'/>"/></span>
                    </div>
                     ...
                     <div class="box-img">
                        <s:iterator value="#request.li" status="index" var="material">
                         	<div class="upwk">
								...
								<!-- 重组并购前后双方企业章程和股东决议扫描件 -->
                                <s:if test="'aaaaaaaaaaaaaaaaaaaaaaaaatplx219'==#material.key">
                                 <div class="s s2">
                                  <%
                                        if (SystemManager.YANGBEN.get("aaaaaaaaaaaaaaaaaaaaaaaaatplx219") != null) {
                                            out.print("<a href=\"");
                                            out.print(SystemManager.YANGBEN.get("aaaaaaaaaaaaaaaaaaaaaaaaatplx219"));
								...
								<!-- 关于并购重组合规性及是否构成关联并购的专项法律意见书 -->
                                <s:if test="'aaaaaaaaaaaaaaaaaaaaaaaaatplx420'==#material.key">
                                 <div class="s s2">
                                  <%
                                        if (SystemManager.YANGBEN.get("aaaaaaaaaaaaaaaaaaaaaaaaatplx420") != null) {
                                            out.print("<a href=\"");
                                            out.print(SystemManager.YANGBEN.get("aaaaaaaaaaaaaaaaaaaaaaaaatplx420"));
                                            out.print("\" target=\"_blank\">查看样本</a>");
                                        } else {
                                            out.print("<a target=\"_blank\">暂无样本</a>");
                                        }
                                ...
                                <!-- 经全省排名前50或全国排名前100的会计师事务所出具的专项审计报告 -->
                                <s:if test="'aaaaaaaaaaaaaaaaaaaaaaaaatplx344'==#material.key">
                                 <div class="s s2">
                                  <%
                                        if (SystemManager.YANGBEN.get("aaaaaaaaaaaaaaaaaaaaaaaaatplx344") != null) {
                                            out.print("<a href=\"");
                                            out.print(SystemManager.YANGBEN.get("aaaaaaaaaaaaaaaaaaaaaaaaatplx344"));
                                            out.print("\" target=\"_blank\">查看样本</a>");
                                        } else {
                                            out.print("<a target=\"_blank\">暂无样本</a>");
                                        }
								...
								<!-- 企业并购重组交易协议及交易金额到账凭证 -->
                                <s:if test="'aaaaaaaaaaaaaaaaaaaaaaaaatplx353'==#material.key">
                                 <div class="s s2">
                                  <%
                                        if (SystemManager.YANGBEN.get("aaaaaaaaaaaaaaaaaaaaaaaaatplx353") != null) {
                                            out.print("<a href=\"");
                                            out.print(SystemManager.YANGBEN.get("aaaaaaaaaaaaaaaaaaaaaaaaatplx353"));
                                            out.print("\" target=\"_blank\">查看样本</a>");
                                        } else {
                                            out.print("<a target=\"_blank\">暂无样本</a>");
                                        }
                                ...
                                <!-- 税务部门出具的企业并购重组相关完税证明 -->
                                <s:if test="'aaaaaaaaaaaaaaaaaaaaaaaaatplx383'==#material.key">
                                 <div class="s s2">
                                  <%
                                        if (SystemManager.YANGBEN.get("aaaaaaaaaaaaaaaaaaaaaaaaatplx383") != null) {
                                            out.print("<a href=\"");
                                            out.print(SystemManager.YANGBEN.get("aaaaaaaaaaaaaaaaaaaaaaaaatplx383"));
                                            out.print("\" target=\"_blank\">查看样本</a>");
                                        } else {
                                            out.print("<a target=\"_blank\">暂无样本</a>");
                                        }
