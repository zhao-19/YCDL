    ...
    $(window).load(function () {
        ...
        if (backnotice == 'success') {
            if(backnoticebzf=='1'){
	            ggts2("数据保存成功！");
	            setTimeout(function(){
	    			window.location="/declare_ipo/selectAllList.html?type=ipohjbt&init=y";
	   			},1500);
		    }
		    if(backnoticebzf=='2'){
		    	ggts2("数据提交成功！");
    ...
    <div class="list fr">
        <div class="rightbox">
            ...
            <div id="zaiquanxinxi-update" class="vipinfo">
                ...
                <form id="form1" action="/declare_ipo/saveData.html" method="post">
                    ...
                    <div class="inputtest inputtestl">
                        <span class="leftname leftnamel">拟上市交易所：<span style="color:red">*</span></span>
					<span class="rightinfo">
						<select isNotNull="拟上市交易所" readonly="readonly" name="e.nssjys" class="select">
                            <option></option>
                            <c:forEach items="${applicationScope.dic.nssjys.childs}" var="datas">
                                <c:if test="${datas.name != '全国中小企业股份转让系统' && datas.name != '川藏所'}"><option value="${datas.id}"
                    ...
                    <div class="inputtest inputtestl">
                        <span class="leftname leftnamel">证监会受理时间：<span style="color:red">*</span></span>
                        <span class="rightinfo"><input class="input stext laydate-icon needDate" readonly="readonly"
                                                       id="slsj"
                                                       name="slsj" type="text"
                                                       value="<s:property value='e.slsj.substring(0,10)'/>"/></span>
                    </div>

                    <div class="inputtest inputtestl">
                        <span class="leftname leftnamel">企业申请金额：<span style="color:red">*</span></span>
                        <span class="rightinfo"><input isNotNull="企业申请金额" isBankZint="isBankZint" onchange="this.value=formatNum(this.value)" isLength="[0,18]"
