    ...
    $(window).load(function () {
        ...
        if (backnotice == 'success') {
            if(backnoticebzf=='1'){
	            ggts2("数据保存成功！");
	            setTimeout(function(){
	    			window.location="/declare_jwzb/selectAllList.html?type=jwsscgbt&init=y";
	   			},1500);
		    }
		    if(backnoticebzf=='2'){
		    	ggts2("数据提交成功！");
        ...
        $(".shangyibu").click(function () {
            ...
            location.href = "/declare_jwzb/toEdit.html?id=" + id;
        });
    ...
    <div class="list fr">
        <div class="rightbox">
            ...
            <div id="zaiquanxinxi-update" class="vipinfo">
                ...
                <form id="form1" action="/declare_jwzb/saveData.html" method="post">
                    ...
                    <div class="inputtest inputtestl">
                        <span class="leftname leftnamel">境外挂牌上市地点：<span style="color:red">*</span></span>
                        <span class="rightinfo"><input isNotNull="境外挂牌上市地点" isLength="[0,16]"  class="input" id="gpdd" name="gpdd" type="text"
                                                       value="<s:property value='e.gpdd'/>"/></span>
                    </div>

                    <div class="inputtest inputtestl">
                        <span class="leftname leftnamel">挂牌上市时间：<span style="color:red">*</span></span>
                    ...
                    <div class="inputtest inputtestl">
                        <span class="leftname leftnamel">挂牌上市所在版块：<span style="color:red">*</span></span>
                        <span class="rightinfo"><input isNotNull="挂牌上市所在版块" isLength="[0,16]" class="input" id="szbk" name="szbk" type="text"
                                                       value="<s:property value='e.szbk'/>"/></span>
                    </div>
                    ...
                    <div class="inputtest inputtestl">
                        ...
                        <span class="rightinfo"><input isNotNull="融资金额" isBankZint="isBankZint" onchange="this.value=formatNum(this.value)" isLength="[0,18]" class="input ibg" id="rzje" name="rzje" type="text"
