	...
	<div class="list fr">
		<div class="rightbox">
			...
			<div id="peixunhuodong" class="vipinfo" >
				...
				<table id="ycacti" name="gdqk"  class="ycactifs pcwxx"  align="center" border="0" cellpadding="0" cellspacing="1">
					<tr>
 						<td colspan="7" >财务情况（万元）</td> 
				...
				<table id="ycacti" name="gdqk"  class="ycactifs"  align="center" border="0" cellpadding="0" cellspacing="1">
