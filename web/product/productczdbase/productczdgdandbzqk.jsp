	...
	<div class="list fr">
		<div class="rightbox">
			...
			<div id="peixunhuodong" class="vipinfo" >
				...
				<form action="/productczdbase!updatestep2.action?e.id=<s:property value='e.id'/>&e.t=<s:property value='e.t'/>"  id="productczdgdandbzqk" name="productczdgdandbzqk" method="post">
				<table id="ycacti" name="gdqk"  class="ycactifs gdqkinputs"  align="center" border="0" cellpadding="0" cellspacing="1">
					<tr>
 						<td colspan="4" >股东情况</td>
					</tr>
				...
				<table id="ycacti"  name="bzgc"  class="ycactifs ycactifsbz"  align="center" border="0" cellpadding="0" cellspacing="1">
					<tr>
 						<td colspan="5" >经营班子构成</td>
					</tr>
					<tr class="TT" lang="firsttr">
 						<td  >职务</td>
 						<td  >姓名</td>
