	...
	<div class="list fr">
		<div class="rightbox">
			...
			<div id="peixunhuodong" class="vipinfo" >
				...
				<form action="/productczdbase!updatestep4.action?e.id=<s:property value='e.id'/>&e.t=<s:property value='e.t'/> " id="productczdjyxx" name="czdsteptwo" method="post">
				<p class="ptitle"><span  class="trleft" >企业主要产品</span><span class="trright" >计量单位：万元</span></p>
				<table id="ycacti" name="gdqk"  class="ycactifs gdqkinputs1"  align="center" border="0" cellpadding="0" cellspacing="1">
				...
				<table id="ycacti"  name="bzgc"  class="ycactifs gdqkinputs2 ycactifsbz"  align="center" border="0" cellpadding="0" cellspacing="1">
					<tr>
 						<td colspan="3" >供应商</td>
					</tr>
				...
				<table id="ycacti"  name="bzgc"  class="ycactifs gdqkinputs3 ycactifsbz"  align="center" border="0" cellpadding="0" cellspacing="1">
					<tr>
 						<td colspan="3" >主要客户</td>
					</tr>
					<tr>
 						<td colspan="3"  class="input trleft">
 						<span>市场集中区域：</span>
