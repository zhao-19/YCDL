...
<link rel="stylesheet" href="/resource/jquery-easyui-1.3.4/themes/default/easyui.css"/>
    ...
    <s:if test="tbotherorg.id!=''">
    	...
    	<tr>
            <td colspan="4" class="table_title">融资租赁数据报送</td>
        </tr>
        <tr>
        ...
        <tr>
            <th class="td_right">当期新签融资租赁合同金额</th>
            <td style="text-align: left;"><fmt:formatNumber value="${e.contract_incre }" pattern="#,#00.00#"/>万元</td>
            <th class="td_right">投放总额</th>
            <td style="text-align: left;"><fmt:formatNumber value="${e.contract_incre_amt}" pattern="#,#00.00#"/>万元</td>
        </tr>
        <tr>
            <th class="td_right">其中：直接融资租赁</th>
            <td style="text-align: left;"><fmt:formatNumber value="${e.contract_direct_incre }" pattern="#,#00.00#"/>万元</td>
            <th class="td_right">售后回租</th>
            <td style="text-align: left;"><fmt:formatNumber value="${e.sell_back_incre}" pattern="#,#00.00#"/>万元</td>
        </tr>
         <tr>
            <th class="td_right">累计融资租赁合同金额</th>
            <td style="text-align: left;"><fmt:formatNumber value="${e.contract_total }" pattern="#,#00.00#"/>万元</td>
            <th class="td_right">投放总额</th>
            <td style="text-align: left;"><fmt:formatNumber value="${e.grant_total_amt}" pattern="#,#00.00#"/>万元</td>
        </tr>
        <tr>
            <th class="td_right">其中：直接融资租赁</th>
            <td style="text-align: left;"><fmt:formatNumber value="${e.contract_total_incre }" pattern="#,#00.00#"/>万元</td>
            <th class="td_right">出售回租</th>
            <td style="text-align: left;"><fmt:formatNumber value="${e.sell_back_total}" pattern="#,#00.00#"/>万元</td>
        </tr>
        <tr>
        ...
        <tr>
            <td colspan="4" style="text-align: center;">
                    <a href="tbjrrzzn!chengeStatus.action?id=${e.id}&status=aaaaaaaaaaaaaaaaaaaaaaaaaaaaa084" class="btn btn-danger">
                        <i class="icon-remove icon-white"></i> 驳回
                    </a>
                    &nbsp;&nbsp;&nbsp;&nbsp;
                    <a href="tbjrrzzn!chengeStatus.action?id=${e.id}&status=aaaaaaaaaaaaaaaaaaaaaaaaaaaaa083" class="btn btn-info">
