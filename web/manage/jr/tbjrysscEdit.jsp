...
<link rel="stylesheet" href="/resource/jquery-easyui-1.3.4/themes/default/easyui.css"/>
    ...
    <s:if test="tbotherorg.id!=''">
    	...
    	<tr>
            <td colspan="4" class="table_title">要素市场数据报送</td>
        </tr>
        <tr>
        ...
        <tr>
            <td colspan="4" style="text-align: center;">
                    <a href="tbjryssc!chengeStatus.action?id=${e.id}&status=aaaaaaaaaaaaaaaaaaaaaaaaaaaaa084" class="btn btn-danger">
                        <i class="icon-remove icon-white"></i> 驳回
                    </a>
                    &nbsp;&nbsp;&nbsp;&nbsp;
                    <a href="tbjryssc!chengeStatus.action?id=${e.id}&status=aaaaaaaaaaaaaaaaaaaaaaaaaaaaa083" class="btn btn-info">
