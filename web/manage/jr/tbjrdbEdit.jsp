...
<link rel="stylesheet" href="/resource/jquery-easyui-1.3.4/themes/default/easyui.css"/>
    ...
    <s:if test="tbotherorg.id!=''">
    	...
    	<tr>
            <td colspan="4" class="table_title">担保公司数据报送</td>
        </tr>
        <tr>
            <th class="td_right">机构名称</th>
        ...
        <tr>
            <th class="td_right">当期担保余额</th>
            <td style="text-align: left;">${e.guar_cu_amt }万元</td>
            <th class="td_right">总担保金额</th>
            <td style="text-align: left;">${e.guar_total_amt}万元</td>
        </tr>
        <tr>
            <th class="td_right">当期代偿金额</th>
            <td style="text-align: left;">${e.guar_cu_compen }万元</td>
            <th class="td_right">新增担保笔数</th>
            <td style="text-align: left;">${e.guar_incre_count}</td>
        </tr>
        <tr>
            <th class="td_right">总担保笔数</th>
            <td style="text-align: left;">${e.guar_total_count }</td>
        ...
        <tr>
            <td colspan="4" style="text-align: center;">
                    <a href="tbjrdb!chengeStatus.action?id=${e.id}&status=aaaaaaaaaaaaaaaaaaaaaaaaaaaaa084" class="btn btn-danger">
                        <i class="icon-remove icon-white"></i> 驳回
                    </a>
                    &nbsp;&nbsp;&nbsp;&nbsp;
                    <a href="tbjrdb!chengeStatus.action?id=${e.id}&status=aaaaaaaaaaaaaaaaaaaaaaaaaaaaa083" class="btn btn-info">
