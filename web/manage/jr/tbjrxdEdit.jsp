...
<link rel="stylesheet" href="/resource/jquery-easyui-1.3.4/themes/default/easyui.css"/>
    ...
    <s:if test="tbotherorg.id!=''">
    	...
    	<tr>
            <td colspan="4" class="table_title">小额贷款数据报送</td>
        </tr>
        <tr>
        ...
        <tr>
            <th class="td_right">当期再贷余额</th>
            <td style="text-align: left;">${e.loan_cu_amt }万元</td>
            <th class="td_right">当期新增贷款金额</th>
            <td style="text-align: left;">${e.loan_incre_amt}万元</td>
        </tr>
        <tr>
            <th class="td_right">当期贷款笔数</th>
            <td style="text-align: left;">${e.loan_cu_count }</td>
            <th class="td_right">总贷款金额</th>
            <td style="text-align: left;">${e.loan_count_amt}万元</td>
        </tr>
        <tr>
            <th class="td_right">总贷款笔数</th>
            <td style="text-align: left;">${e.loan_count }</td>
            <th class="td_right">贷款客户所属行业(前三位)</th>
            <td style="text-align: left;">${e.invest_industry}</td>
        </tr>
        <tr>
            <th class="td_right">营业收入</th>
            <td style="text-align: left;">${e.business_income}万元</td>
            <th class="td_right">净利润</th>
            <td style="text-align: left;">${e.profit }万元</td>
        </tr>
        <tr>
            <th class="td_right">固定资产折旧</th>
            <td style="text-align: left;">${e.fixed_assets}万元</td>
            <th class="td_right">无形资产摊销</th>
            <td style="text-align: left;">${e.intangible_assets }万元</td>
        </tr>
        <tr>
            <th class="td_right">人员薪酬及福利</th>
            <td style="text-align: left;">${e.salaries}万元</td>
            <th class="td_right">增值税</th>
            <td style="text-align: left;">${e.added_tax }万元</td>
        </tr>
        <tr>
            <th class="td_right">所得税</th>
            <td style="text-align: left;">${e.income_tax}万元</td>
            <th class="td_right">其他税金及附加</th>
            <td style="text-align: left;">${e.other_tax }万元</td>
        </tr>
         <tr>
        ...
        <tr>
            <td colspan="4" style="text-align: center;">
                    <a href="tbjrxd!chengeStatus.action?id=${e.id}&status=aaaaaaaaaaaaaaaaaaaaaaaaaaaaa084" class="btn btn-danger">
                        <i class="icon-remove icon-white"></i> 驳回
                    </a>
                    &nbsp;&nbsp;&nbsp;&nbsp;
                    <a href="tbjrxd!chengeStatus.action?id=${e.id}&status=aaaaaaaaaaaaaaaaaaaaaaaaaaaaa083" class="btn btn-info">
