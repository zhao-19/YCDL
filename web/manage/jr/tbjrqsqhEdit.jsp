...
<link rel="stylesheet" href="/resource/jquery-easyui-1.3.4/themes/default/easyui.css"/>
    ...
    <s:if test="tbotherorg.id!=''">
    	...
    	<tr>
            <td colspan="4" class="table_title">券商期货数据报送</td>
        </tr>
        <tr>
        ...
        <tr>
            <th class="td_right">全年证券交易量（期货交易量）</th>
            <td style="text-align: left;"><fmt:formatNumber value="${e.transaction_amount }" pattern="#,#00.00#"/>万元</td>
            <th class="td_right">高新区内网点数</th>
            <td style="text-align: left;">${e.point_count}</td>
        </tr>
        <tr>
        ...
        <tr>
            <td colspan="4" style="text-align: center;">
                    <a href="tbjrqsqh!chengeStatus.action?id=${e.id}&status=aaaaaaaaaaaaaaaaaaaaaaaaaaaaa084" class="btn btn-danger">
                        <i class="icon-remove icon-white"></i> 驳回
                    </a>
                    &nbsp;&nbsp;&nbsp;&nbsp;
                    <a href="tbjrqsqh!chengeStatus.action?id=${e.id}&status=aaaaaaaaaaaaaaaaaaaaaaaaaaaaa083" class="btn btn-info">
