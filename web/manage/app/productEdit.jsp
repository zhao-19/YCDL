...
<s:form action="/manage/appGoods!update.action" id="form" name="form" theme="simple" method="post">
    <div style="text-align: center;">
	       ...
	       <button  class="btn btn-success" onclick="summitform();">
	           <i class="icon-ok icon-white"></i> 保存
	       </button>
	       
                  <s:iterator value="#request.buttonlist" var="button" status="st">
                  <s:if test="apporpc != 2 && type!=14101">
                                <span taskid="${taskid}" apporpc="<s:property value="#button.apporpc" />" type="<s:property value="#button.type" />" instanceid="${instanceid }" userid="${creator }"
                                    buttonid="<s:property value="#button.id" />"
                                    class="btn btn-info oper"> <i
                                    class="icon-ok icon-white "></i> <span> <s:property
                                            value="#button.name" />
                                </span>
                                </span>
                      </s:if>    
                            </s:iterator>
           	<span style="color:red;" id="apptable">如要修改数据，请先点保存再审核。</span>
    </div>

    <div id="tabs">

        <ul>
           <c:if test="${not empty result}"><li><a href="#tabs-8">流程信息</a></li></c:if>
        ...
        <div id="tabs-8">
                <img src="${wfimg }rest/showflowpic?instanceid=${result.data.instanceid}"/>
        ...
        <div id="tabs-1">
            ...
            <tr>
                ...
                <td style="text-align: left;" colspan="3"><s:checkboxlist
                        name="product.loangur" id="loangur" list="%{#request.gur2list}"
                        listKey="id" listValue="name"  
                        value="#request.product.loangur.split(',')" /></td>
            </tr>
            ...
            <tr>
                ...
                <th class="td_right">最大贷款金额（万元）（整数）</th>
            ...
            <tr>
                ...
                <th class="td_right">申请次数加权</th>
                <td style="text-align: left;">
                	<s:textfield name="product.applytimes" id="applytimes" readonly="false"
                                data-rule="申请次数加权:required;applytimes;Integer"/>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td style="text-align: left;"><s:select
                        list="%{#request.loanstype}" listKey="id" listValue="name" headerKey="" headerValue="-请选择-"
                ...
                <td style="text-align: left;"><s:select
                        list="%{#request.publishtype}" listKey="id" listValue="name" headerKey="" headerValue="-请选择-"
            ...
            <tr>
                <th class="td_right">标签(用空格分隔，最多七个)</th>
            ...
            <tr>
                ...
                <td style="text-align: left;">
                	<s:select list="%{#request.areamap}" headerKey="all" headerValue="" theme="simple"
                        name="product.substation" id="substation"/>
                </td>
                <th class="td_right">贷款用途</th>
                <td style="text-align: left;">
                	<s:select
                        list="%{#application.dic.loanusage.childs}" listKey="id" listValue="name" headerKey="" headerValue=""
                        name="product.loanusage" id="proloanusage" />
                </td>
            </tr>
            ...
            <tr>
                ...
                <td style="text-align: left;"><s:textfield name="product.appid"
                       ...
                       <c:if test="${product.appid eq '' or empty product.appid }">
                        <s:a href="javascript:getAppList(3)" cssClass="btn btn-success" id="selectPbczdbase">请选择</s:a>
                        </c:if>
                        </td>
        ...
        <div id="tabs-2">
            ...
            <tr>
                ...
                <td style="text-align: left;"><input type="button"
                    name="filemanager1" id="filemanager1" value="产品图标（300*300）" class="btn btn-success" /></td>
                     <td style="text-align: left;" colspan="3"><s:textfield
            ...
            <tr>
                ...
                <th class="td_right">app发布编号</th>
                <td style="text-align: left;"><s:textfield name="incre.appid"
                        id="goodsappid" readonly="true" />
                        <c:if test="${incre.appid eq '' or empty incre.appid }">
                        <s:a href="javascript:getAppList(2)" cssClass="btn btn-success" id="selectPbczdbase">请选择</s:a>
                        </c:if>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td style="text-align: left;">
                	<s:select list="%{#request.areamap}" headerKey="all" headerValue="" theme="simple"
                        name="incre.substation" id="incresubstation"/>
                </td>
                <th class="td_right"></th>
                <td style="text-align: left;"></td>
            </tr>
            ...
            <tr>
                    <td class="td_right"><span class="leftname leftnamel"><input
                            ...
                            value="详情图片1（720*288）" class="btn btn-success" /></span></td>
            ...
            <tr>
                    <td class="td_right"><span class="leftname leftnamel"><input
                            ...
                            value="详情图片2（720*288）" class="btn btn-success" /></span></td>
                    <td style="text-align: left;" colspan="3"><span class="rightinfo"><input
            ...
            <tr>
                    <td class="td_right"><span class="leftname leftnamel"><input
                            ...
                            value="详情图片3（720*288）" class="btn btn-success" /></span></td>
                    <td style="text-align: left;" colspan="3"><span class="rightinfo"><input
                ...
                <table class="table table-bordered">
                    ...
                    <tr>
                        ...
                        <td style="text-align: left;"><s:textfield name="pcgoods.appid"
                            ...
                            <s:a href="javascript:getAppList(1)" cssClass="btn btn-success" id="selectPbczdbase">请选择</s:a>
                            </c:if></td>
                    </tr>
                    <tr>
                        <th class="td_right">企业id</th>
        ...
        <div id="tabs-4">
        	<c:choose>  
                ...
                <thead>
	                ...
	                <tr>
	                    ...
	                    <td style="text-align: left;" colspan="4">
	                    	...
	                    	<button  class="btn btn-success" onclick="queryqiyes();">
              ...
              <table id="qiyeTable" class="table table-condensed">
                ...
                <s:iterator value="custList" var="culi">
                <tr>
  ...
  <div id="shyj">
    <div id="shyj_c">
        ...
        <p>
            ...
            <button type="submit" id="shyjsubmit" method="productapp!operate.action" class="btn btn-success" style="margin-left:20px;">
...
function summitform() {
    ...
    var field3 = new Array("id", "prodid", "prodname", "loanterm", "loantermmax", "loanamt", "loanamtmax", "retutype", "loanrate", "loanarea", "banks", "shifoutuijian","applytimes", "tuijianpic", 
             "loancondition", "productdetail", "biaoqian", "openstat", "product_type", "rele_type", "rele_bankid", "rele_userid", "datasource", "appid", "description", "guaranteefee", "servicecharge", "totalcost", "sort","flowno", "substation", "longitude", "latitude","usedistrict","loanusage");
    ...
    if (submitcheck) {
        ...
        $.ajax({
            type: 'post',
            url: "/manage/appGoods!saveAllData.action",
            data: para,
            dataType:"json",
...
function queryqiyes() {
	...
	$.ajax({
		type : "post",
		url : "/manage/appGoods!queryqiye.action",
		...
		success : function(data) {
	    	...
	    	for (var i = 0; i < data.length; i ++ ) {
	    		...
	    		html.push("	<td>");
	    		html.push("		<button class='btn btn-success addqiyebutton' onclick='addqiyes(this);'><i class='icon-search icon-white'></i>添加</button>");
