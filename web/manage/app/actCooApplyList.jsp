...
<s:form action="enterPark!selectList.action" namespace="/" method="post" theme="simple">
    <table class="table table-bordered table-condensed">
        ...
        <tr>
            <td colspan="11">
                <button method="actCooApply!selectList.action" class="btn btn-primary" onclick="selectList(this)">
    ...
    <table class="table table-bordered table-hover">
        ...
        <s:iterator value="pager.list" var="alist">
            <tr>
                ...
                <td>&nbsp;${createdate }</td>
                <td>
                    <s:a href="actCooApply!toEdit.action?e.pkid=%{pkid}" escapeAmp="" class="btn btn-mini btn-success">申请详情</s:a>&nbsp;&nbsp;
...
<div id="ldksq">
    ...
    <script type="text/javascript">
        ...
        function showReviews(pkid) {
            ...
            //1.查询之后返回到当前
            $.post("actCooApply!toReviewLog.action", {
                "pkid" : pkid
            }, function(data) {
