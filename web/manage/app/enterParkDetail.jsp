	...
	<s:form action="enterPark" namespace="/manage" theme="simple" id="form"
		...
		<tr id="ids" style="display:none;"><td>
            ...
            <tr>
                ...
                <td style="text-align: left;"><s:textfield name="e.cname"
                        id="cname" readonly="true" /></td>

                <th class="td_right">行业</th>
                <td style="text-align: left;"><s:textfield
                        name="e.industry" id="industry" readonly="true" /></td>
            </tr>

 <tr>
                <th class="td_right">公司规模</th>
                <td style="text-align: left;"><s:textfield name="e.cmpscope"
                        id="cmpscope" readonly="true" /></td>

                <th class="td_right">电话</th>
                <td style="text-align: left;"><s:textfield
                        name="e.cellphone" id="cellphone" readonly="true" /></td>
            </tr>
			<tr>
				<th class="td_right">园区名称</th>
				<td style="text-align: left;" colspan="3"><s:textfield
						name="e.parkname" id="content" 
						readonly="true" /></td>
			</tr>
<tr>
