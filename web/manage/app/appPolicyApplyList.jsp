...
<body>
<s:form action="policyApply!selectList.action" namespace="/" method="post" theme="simple">
    <table class="table table-bordered table-condensed">
        <!--查询条件-->
        <tr>
             <td style="text-align: right;">企业名称</td>
            <td style="text-align: left;">
                <s:textfield name="e.cmpname" id="cmpname" readonly="false"/>
            </td>
        ...
        <tr>
            <td colspan="11">
                <button method="policyApply!selectList.action" class="btn btn-primary" onclick="selectList(this)">
    ...
    <table class="table table-bordered table-hover">
        ...
        <s:iterator value="pager.list" var="alist">
            <tr>
                ...
                <td>
                    <s:a href="policyApply!toEdit.action?e.pkid=%{pkid}" escapeAmp="" class="btn btn-mini btn-success">申请详情</s:a>&nbsp;&nbsp;
