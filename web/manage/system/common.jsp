...
<link rel="stylesheet" href="<%=request.getContextPath()%>/resource/css/base.css?${sysversion}"  type="text/css">
...
<script type="text/javascript" src="<%=request.getContextPath()%>/resource/drag/dragImg.js"></script>
