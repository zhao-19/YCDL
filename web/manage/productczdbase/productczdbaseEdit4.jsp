   ...
   /*  function refresh(value){
		...
		<!-- 	<s:if test="e.id=='' or e.id==null">
			...
			-->
				...
				<!--<s:iterator value="#request.buttonlistnum" var="button" status="st">-->
                   <!--<button method="productczdbase!updateGZL.action?taskid=%{taskid}&buttonnum=<s:property value="#button" />" class="btn btn-success" >-->
                                                                       <!--<s:property value="#request.buttonlistname[]" /> 保存-->
                   <!--</button>-->
               <!--</s:iterator>-->
				<s:iterator value="#request.buttonlist" var="button" status="st">

					<span  buttonid="<s:property value="#button.key"/>" class="btn btn-info oper">
						 ...
						 <table class="table table-bordered">
							 ...
							 <tr>
								 ...
								 <td style="text-align: left;">
									 ...
									 <input style="margin-top:-5px!important;height:auto;padding:0px 2px;" type="button" value="修改" id="editcp"/>
								 </td>
...
<div id="ldksq">
    <div id="ldksq_c">
        ...
        <form action="productczdbase!updateGZL.action" name="indexdksq" id="indexdksq" method="post">
