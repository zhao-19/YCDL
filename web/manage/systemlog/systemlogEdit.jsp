...
<body>
	<s:form action="systemlog" namespace="/manage" theme="simple">
				<table class="table table-bordered">
					...
					<tr>
						...
						<td style="text-align: left;"><s:select
								list="#{0:'--全部--',1:'登陆日志',2:'版本日志'}"
								name="e.type" id="type" listKey="key" listValue="value" /></td>
					</tr>
					<tr>
						<td style="text-align: right;">内容</td>
						<td style="text-align: left;"><s:textarea name="e.content" style="width:100%;height:250px;visibility:hidden;"></s:textarea></td>
					</tr>
					<tr>
