...
<p><span id="close">&nbsp;X&nbsp;</span></p>
<p>您的浏览器版本过低，后台管理，建议您统一使用chrome谷歌标准浏览器!</p>
<p><a href="https://www.baidu.com/s?word=google浏览器官方下载" target="_black" id="down">立即去下载</a></p>
</div>

<style type="text/css">
.browsercheck{display:none;z-index:99999;position:absolute;top:0px;left:0;width:100%;background-color:#FEB961;;text-align:center;line-height:30px;font-size:16px;}
#close{float: right;margin-right: 30px;color: #F87E59;padding: 0px 4px;cursor: pointer;}
#close:hover{color:red;}
#down{background: url("../../image/box/cre_icon3.png") center center;padding:4px 6px;color: #fff;text-decoration: none;}
#down:hover{background-position:0 69px;text-decoration: none;}
...
if((NV.name) !='chrome'){
	...
	setInterval(function(){$("#browsercheck").slideUp();},30000);
	
}
$("#close").click(function(){
	//alert(1);
	$("#browsercheck").slideUp(500);
});
/*
