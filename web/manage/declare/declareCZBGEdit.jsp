...
<s:form action="declare_czbg" namespace="/manage" theme="simple" id="form" lang="isBank">
    <table class="table table-bordered">
        ...
        <tr>
            ...
            <td style="text-align: left;">
                <s:textfield name="e.userid" id="userid" readonly="false" data-rule="主键:required;userid;length[0~32]"/>
            </td>

            <th class="td_right">申请方向</th>
            <td style="text-align: left;">
                    <%--<s:textfield name="e.sqfx" id="sqfx" readonly="false" data-rule="申请方向:required;sqfx;length[0~16]"/>--%>
                <select class="select" name="sqfx" id="sqfx">
                    <option value=""></option>
        ...
        <tr>
            <th class="td_right">交易对手企业名称</th>
            <td style="text-align: left;">
                <s:textfield name="e.bbgqymc" id="bbgqymc" readonly="false"
                             data-rule="交易对手企业名称:required;bbgqymc;length[0~32]"/>
            </td>

            <th class="td_right">交易金额（万元）</th>
            <td style="text-align: left;">
                <s:textfield name="e.jyje" isBankZint="isBankZint" onchange="this.value=formatNum(this.value)" id="jyje" readonly="false" data-rule="交易金额:required;jyje;length[0~9]"/>
            </td>
        </tr>
	 ...
	 对企业进行的境内并购重组，按交易金额的2%，给予最高100万元奖励；对企业进行的境外并购重组，按交易金额的5%，给予最高200万元奖励；对企业进行的“一带一路”沿线地区并购重组，按交易金额的5%，给予最高300万元奖励；对销售收入小于1亿元且保留法人资格的企业，被并购后，按交易金额的2%，给予最高50万元奖励
<!-- 对进行非关联并购重组交易的企业，按交易金额的2%给予并购企业补贴且补贴金额最高不超过100万元。
对销售收入小于2000万，被并购后保留法人资格且交易额小于本企业净资产5倍的小微企业，按交易金额的2%给予被并购企业最高不超过50万元的补贴。	-->
        ...
        <tr>
            <td colspan="4" style="text-align: center;">
                ...
                <s:if test="e.id=='' or e.id==null">
                    <button method="declare_czbg!insert.action" class="btn btn-success">
                        <i class="icon-ok icon-white"></i> 新增
                    </button>
                </s:if>
                <s:else>
                    <button method="declare_czbg!update.action" class="btn btn-success">
                        <i class="icon-ok icon-white"></i> 保存
                    </button>
                    &nbsp;&nbsp;&nbsp;&nbsp;
                    <span method="declare_czbg!update.action" id="backButton" onclick="statusset('0')" class="btn btn-danger">
                        <i class="icon-ok icon-white"></i> 驳回
                    </span>
                    &nbsp;&nbsp;&nbsp;&nbsp;

                    <span method="declare_czbg!update.action" id="successButton" onclick="statusset('1')" class="btn btn-info">
    ...
    <div id="ldksq">
        <div id="ldksq_c">
            ...
            <p>
                ...
                <button  method="declare_czbg!update.action" class="btn btn-success" style="margin-left:20px;">
  ...
  function toBaseEdit(userid) {
    ...
    $(function () {
        ...
        $("#successButton").click(function () {
            var content = lxr + "您好，"+ qiyemingcheng +"申请的重组并购申请补贴获得成都高新区财政金融局初审通过，请根据操作手册说明从系统导出资料，双面打印并胶装，签字盖章后交到锦城大道539号盈创动力大厦A座五楼且带上财务章（用于收据盖章）。如有疑问请联系申报通知中对应的联系人。";
        ...
        $("#backButton").click(function () {
            ...
            var content = lxr + "您好，很遗憾"+ qiyemingcheng +"申请的重组并购申请补贴未获得成都高新区财政金融局初审通过，原因：xxxxxxxxxxxxxxxxxxxx。如有疑问请联系申报通知中对应的联系人。";
