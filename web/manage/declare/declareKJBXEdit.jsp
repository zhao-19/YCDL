...
<s:form action="declare_kjbx" namespace="/manage" theme="simple" id="form" lang="isBank">
...
企业购买重点引导类科技保险险种，按实际保费支出的40%，给予最高20万元补贴；购买一般引导类科技保险险种，按实际保费支出的20%，给予最高20万元补贴。
    ...
    <table class="table table-condensed">
        ...
        <s:iterator value="e.declareKJBXCoreList">
            <tr>
                <td>&nbsp;<s:property value="userid"/></td>
                <td>&nbsp;<s:property value="baoxiangongsi"/></td>
                <td>&nbsp;<s:property value="toubaopinzhogn"/></td>
                <td>&nbsp;<s:property value="baofei"/> 万</td>
        ...
        <tr>
            <td colspan="4" style="text-align: center;">
                ...
                <s:if test="e.id=='' or e.id==null">
                    <button method="declare_kjbx!insert.action" class="btn btn-success">
                        <i class="icon-ok icon-white"></i> 新增
                    </button>
                </s:if>
                <s:else>
                    <button method="declare_kjbx!update.action" class="btn btn-success">
                        <i class="icon-ok icon-white"></i> 保存
                    </button>
                    &nbsp;&nbsp;&nbsp;&nbsp;
                    <span method="declare_kjbx!update.action" id="backButton" onclick="statusset('0')"
                          class="btn btn-danger">
                        <i class="icon-ok icon-white"></i> 驳回
                    </span>
                    &nbsp;&nbsp;&nbsp;&nbsp;

                    <span method="declare_kjbx!update.action" id="successButton" onclick="statusset('1')"
                          class="btn btn-info">
    ...
    <div id="ldksq">
        <div id="ldksq_c">
            ...
            <p>
                ...
                <button method="declare_kjbx!update.action" class="btn btn-success" style="margin-left:20px;">
  ...
  function toBaseEdit(userid) {
    ...
    function toCodeEdit(id) {
        layer.open({
            ...
            fix: false, //不固定
            maxmin: false,
            content: 'declare_kjbx_core!toEdit.action?id=' + id
        });
    }
    ...
    $(function () {
        ...
        $("#successButton").click(function () {
            var content = lxr + "您好，"+ qiyemingcheng +"申请的科技保险政策获得成都高新区财政金融局初审通过，请根据操作手册说明从系统导出资料，双面打印并胶装，签字盖章后交到锦城大道539号盈创动力大厦A座五楼且带上财务章（用于收据盖章）。如有疑问请联系申报通知中对应的联系人。";
        ...
        $("#backButton").click(function () {
            ...
            var content = lxr + "您好，很遗憾"+ qiyemingcheng +"申请的科技保险政策未获得成都高新区财政金融局初审通过，原因：xxxxxxxxxxxxxxxxxxxx。如有疑问请联系申报通知中对应的联系人。";
