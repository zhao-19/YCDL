...
<s:form action="declare_ipo" namespace="/manage" theme="simple" id="form" lang="isBank">
    <table class="table table-bordered">
        ...
        <tr>
            <th class="td_right">证监会受理时间</th>
            <td style="text-align: left;">
                <s:textfield name="e.slsj" id="slsj" readonly="false" data-rule="证监会受理时间:required;slsj;"/>
            </td>
...
<!--企业获得证监会正式受理申报沪深交易所，给予企业200万元的一次性补贴。-->
对提交境内上市申请被证监会正式受理的企业，给予200万元奖励。
	</td>
	</tr>
        ...
        <tr>
            <td colspan="4" style="text-align: center;">
                ...
                <s:if test="e.id=='' or e.id==null">
                    <button method="declare_ipo!insert.action" class="btn btn-success">
                        <i class="icon-ok icon-white"></i> 新增
                    </button>
                </s:if>
                <s:else>
                    <button method="declare_ipo!update.action" class="btn btn-success">
                        <i class="icon-ok icon-white"></i> 保存
                    </button>
                    &nbsp;&nbsp;&nbsp;&nbsp;
                    <span method="declare_ipo!update.action" id="backButton"  onclick="statusset('0')" class="btn btn-danger">
                        <i class="icon-ok icon-white"></i> 驳回
                    </span>
                    &nbsp;&nbsp;&nbsp;&nbsp;

                    <span method="declare_ipo!update.action" id="successButton" onclick="statusset('1')" class="btn btn-info">
    ...
    <div id="ldksq">
        <div id="ldksq_c">
            ...
            <p>
                ...
                <button  method="declare_ipo!update.action" class="btn btn-success" style="margin-left:20px;">
...
//        }
    ...
    $(function () {
        ...
        $("#successButton").click(function () {
            var content = lxr + "您好，"+ qiyemingcheng +"申请的IPO获得证监会受理申请补贴获得成都高新区财政金融局初审通过，请根据操作手册说明从系统导出资料，双面打印并胶装，签字盖章后交到锦城大道539号盈创动力大厦A座五楼且带上财务章（用于收据盖章）。如有疑问请联系申报通知中对应的联系人。";
        ...
        $("#backButton").click(function () {
            ...
            var content = lxr + "您好，很遗憾"+ qiyemingcheng +"申请的IPO获得证监会受理申请补贴未获得成都高新区财政金融局初审通过，原因：xxxxxxxxxxxxxxxxxxxx。如有疑问请联系申报通知中对应的联系人。";
