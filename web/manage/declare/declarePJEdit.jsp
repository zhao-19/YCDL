...
<s:form action="declare_pj" namespace="/manage" theme="simple" id="form" lang="isBank">
    <table class="table table-bordered">
        ...
        <tr>
            <th class="td_right">评级机构</th>
            <td style="text-align: left;">
                <s:textfield name="e.pjorg" id="pjorg" readonly="false" data-rule="评级机构:required;pjorg;length[0~64]"/>
            </td>
            <th class="td_right">评级结果</th>
            <td style="text-align: left;">
                <s:textfield name="e.pjjg" id="pjjg" readonly="false" data-rule="评级结果:required;pjjg;length[0~8]"/>
            </td>
        </tr>

        <tr>
            <th class="td_right">评级时间</th>
            <td style="text-align: left;">
                <s:textfield name="e.pjsj" id="pjsj" readonly="false" data-rule="评级时间:required;pjsj;"/>
            </td>
            <th class="td_right">评级费用（万元）</th>
            <td style="text-align: left;">
                <s:textfield name="e.pjfy" isBankZint="isBankZint" onchange="this.value=formatNum(this.value)" id="pjfy" readonly="false" data-rule="评级费用:required;pjfy;length[0~9]"/>
            </td>
        </tr>
...
<!-- 旧：<br/>
方向一：因申报贷款贴息而参加第三方信用评级的企业，按评级费50%给予企业补贴。最高不超过10万。<br/>
方向二：自愿参加信用评级的企业，按评级费的50%给予企业补贴，最高不超过10万。<br/>
方向三：对编写上市企业社会责任报告的企业，按产生费用的50%给予最高不超过10万元。
<br/>
新<br/> -->
对参加信用评级的企业，按评级费用的50%，给予最高10万元补贴
        ...
        <tr>
            <td colspan="4" style="text-align: center;">
                ...
                <s:if test="e.id=='' or e.id==null">
                    <button method="declare_pj!insert.action" class="btn btn-success">
                        <i class="icon-ok icon-white"></i> 新增
                    </button>
                </s:if>
                <s:else>
                    <button method="declare_pj!update.action" class="btn btn-success">
                        <i class="icon-ok icon-white"></i> 保存
                    </button>
                    &nbsp;&nbsp;&nbsp;&nbsp;
                    <span method="declare_pj!update.action" id="backButton" onclick="statusset('0')" class="btn btn-danger">
                        <i class="icon-ok icon-white"></i> 驳回
                    </span>
                    &nbsp;&nbsp;&nbsp;&nbsp;

                    <span method="declare_pj!update.action" id="successButton" onclick="statusset('1')" class="btn btn-info">
    ...
    <div id="ldksq">
        <div id="ldksq_c">
            ...
            <p>
                ...
                <button  method="declare_pj!update.action" class="btn btn-success" style="margin-left:20px;">
...
//        }
    ...
    $(function () {
        ...
        $("#successButton").click(function () {
            var content = lxr + "您好，"+ qiyemingcheng +"申请的信用评级补贴获得成都高新区财政金融局初审通过，请根据操作手册说明从系统导出资料，双面打印并胶装，签字盖章后交到锦城大道539号盈创动力大厦A座五楼且带上财务章（用于收据盖章）。如有疑问请联系申报通知中对应的联系人。";
        ...
        $("#backButton").click(function () {
            ...
            var content = lxr + "您好，很遗憾"+ qiyemingcheng +"申请的信用评级补贴未获得成都高新区财政金融局初审通过，原因：xxxxxxxxxxxxxxxxxxxx。如有疑问请联系申报通知中对应的联系人。";
