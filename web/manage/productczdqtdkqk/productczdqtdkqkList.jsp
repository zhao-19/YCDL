...
<body>
<s:form action="productczdqtdkqk!selectList.action" namespace="/" method="post" theme="simple">
	<table class="table table-bordered table-condensed">
		...
		<tr>
			...
			<td style="text-align: right;">债权银行</td>
			<td style="text-align: left;" >
				<s:textfield name="e.zhaiquanyinhang" id="zhaiquanyinhang" readonly="false" />
			</td>
 				
			<td style="text-align: right;">贷款余额</td>
			<td style="text-align: left;" >
				<s:textfield name="e.daikuanyue" id="daikuanyue" readonly="false" />
			</td>
 				
			<td style="text-align: right;">贷款方式</td>
			<td style="text-align: left;" >
				<s:textfield name="e.daikuanfangshi" id="daikuanfangshi" readonly="false" />
			</td>
 				
			<td style="text-align: right;">借款日期</td>
			<td style="text-align: left;" >
				<s:textfield name="e.jiekuanriqi" id="jiekuanriqi" readonly="false" />
			</td>
		...
		<tr>
			<td colspan="11">
				<%if(PrivilegeUtil.check(request.getSession(), "productczdqtdkqk!selectList.action")){%>

					<button method="productczdqtdkqk!selectList.action" class="btn btn-primary" onclick="selectList(this)">
						<i class="icon-search icon-white"></i> 查询
					</button>
				<%} %>
				<%if(PrivilegeUtil.check(request.getSession(), "productczdqtdkqk!insert.action")){%>
					<s:a method="toAdd" cssClass="btn btn-success">
						<i class="icon-plus-sign icon-white"></i> 添加
					</s:a>
				<%} %>
				<%if(PrivilegeUtil.check(request.getSession(), "productczdqtdkqk!deletes.action")){%>
			...
			<tr >
				...
				<td  style="display: none;">&nbsp;<s:property value="id"/></td>
								...
								<td>&nbsp;<s:property value="id"/></td>
 								...
 								<td>&nbsp;<s:property value="daikuanyue"/></td>
				...
				<td>
					...
					<s:a href="productczdqtdkqk!toEdit.action?e.id=%{id}">编辑</s:a>
				</td>
			</tr>
		</s:iterator>
