...
<body>
<s:form action="accountRank" namespace="/manage" theme="simple" id="form" >
	<table class="table table-bordered">
		...
		<tr>
			...
			<td style="text-align: left;"><s:textfield name="e.code" id="code" data-rule="code:required;code;length[1~10];"/></td>
		</tr>
		<tr>
			<td style="text-align: right;">等级名称</td>   
			<td style="text-align: left;"><s:textfield name="e.name" data-rule="等级名称:required;name;length[1~10];"
					id="name"></s:textfield></td>
		</tr>
		<tr>
			<td style="text-align: right;">最小积分</td>
			<td style="text-align: left;"><s:textfield name="e.minScore" data-rule="最小积分:integer;minScore;length[1~10];" 
					id="minScore" /></td>
		</tr>
		<tr>
			<td style="text-align: right;">最大积分</td>
			<td style="text-align: left;"><s:textfield name="e.maxScore" data-rule="最大积分:integer;maxScore;length[1~10];" 
					id="maxScore" /></td>
		</tr>
		<tr>
