...
<s:else>
	...
	<s:form action="sbxsgjccore" namespace="/manage" theme="simple" id="form">
		<table class="table table-bordered">
			...
			<tr style="display:none;">
				...
				<th class="td_right"></th>
				<td style="text-align: left;">
				<s:textfield name="e.xsgcount" id="xsgcount" readonly="false" data-rule=":required;xsgcount;length[2~9]"/>
				</td>
				</tr>
				...
				<th class="td_right"></th>
				<td style="text-align: left;">
				<s:textfield name="e.price" id="price" readonly="false" data-rule=":required;price;length[2~9]"/>
				</td>
				</tr>
			...
			<tr >
				<td colspan="2" style="text-align: center;">
					<s:if test="e.id=='' or e.id==null">
						<button method="sbxsgjccore!insert.action" class="btn btn-success">
							<i class="icon-ok icon-white"></i> ÐÂÔö
						</button>
					</s:if>
					<s:else>
						<button method="sbxsgjccore!update.action" class="btn btn-success">
