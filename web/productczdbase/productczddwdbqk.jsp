	...
	<div class="list fr">
		<div class="rightbox">
			...
			<div id="peixunhuodong" class="vipinfo" >
				...
				<form action="/productczdbase!updatestep6.action?e.id=${e.id}&e.t=${e.t}&taskid=${taskid}" id="productczddwdbqk" name="czdsteptwo" method="post">
 				<table id="ycacti"  name="bzgc"  class="ycactifs gdqkinputs zqrztable"  align="center" border="0" cellpadding="0" cellspacing="1">
					<tr>
 						<td colspan="5" class="tabletitle">企业目前对外担保情况</td>
					</tr>
				...
				<table id="ycacti"  name="bzgc"  class="ycactifs zqrztable"  align="center" border="0" cellpadding="0" cellspacing="1">
					<tr>
 						<td colspan="5" class="tabletitle">本次贷款的反担保措施</td> <input type="hidden" name="fdbcs.id" value="<s:property value='fdbcs.id'/>" />
					</tr>
					<tr lang="firsttr" class="TT">
 						<td  >保证担保</td>
 						<td  >质押担保</td>
					...
					<tr>
 						<td  class="input"   >
	 						...
	 						<select class="dbselect"  name="fdbcs.baozhegndanbao">
	 							<option <%if ("无".equals(((com.winpow.services.manage.productczdfdbcs.bean.Productczdfdbcs) request.getAttribute("fdbcs")).getBaozhegndanbao())) { out.print("selected=selected");}  %> name="无" >无</option>
