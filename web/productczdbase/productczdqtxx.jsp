		...
		<div class="rightbox">
			...
			<div id="peixunhuodong" class="vipinfo" >
				...
				<form action="/productczdbase!submit.action" id="productczdqtxx" name="czdsteptwo" method="post">
 				<table id="ycacti"  name="bzgc"  class="ycactifs zqrztable"  align="center" border="0" cellpadding="0" cellspacing="1">
 				
					<tr>
 						<td colspan="4"  class="tabletitle">2018年度情况<input type="hidden"  name="qtxx.id"    value="<s:property value='qtxx.id'/>">
					...
					<tr>
					 ...
					 <tr><td colspan="4" class="tabletitle">三年借款/还款</td></tr>
					
					<tr>
 						<td style="width:134px;">三年累计借款<br/>(万元)</td>
						...
						<td style="width:134px;">三年累计归还<br/>(万元)</td>
					...
					<tr>
 						<td colspan="4"  class="tabletitle">知识产权/标准</td>
					</tr>
					<tr>
					...
					<tr>
 						<td colspan="4" class="tabletitle">权威认定</td>
					</tr>
					<tr>
 						<td colspan="4" class="input trleft" >
					...
					<tr>
 						<td colspan="4"  class="tabletitle">技术应用情况（技术应用的市场前景）</td>
					</tr>
					<tr>
 						<td class="input trleft" colspan="4" >
					...
					<tr>
 						<td colspan="4"  class="tabletitle">行业情况及企业简介</td>
					</tr>
					<tr>
 						<td class="input trleft" colspan="4" >
				 	...
				 	<tr>
 						<td colspan="4"  class="tabletitle">主要产品介绍</td>
					</tr>
					<tr>
 						<td class="input trleft" colspan="4" >
					...
					<tr>
 						<td colspan="4" class="tabletitle">产品竞争力</td>
					</tr>
					<tr>
 						<td class="input trleft" colspan="4" >
					...
					<tr>
 						<td colspan="4" class="tabletitle">高管团队（教育背景及学历、行业从业经历等）</td>
					</tr>
					<tr>
 						<td class="input trleft" colspan="4" >
					...
					<tr>
 						<td colspan="4" class="tabletitle">市场拓展的前景</td>
					</tr>
					<tr>
 						<td class="input trleft" colspan="4" >
					...
					<tr class="tijiao">
						<td colspan="4">
						<input type="button"  id="czdsteponesave" lang="<s:property value="id"/>"   name="czdsteponesave"  value="上一步"/>&nbsp;&nbsp;&nbsp;
						<input type="button"  id="czdsteponesbt_zc"  lang="<s:property value="id"/>"   name="czdsteponesbt" value="暂存"/>&nbsp;&nbsp;&nbsp;  
					<s:if test="#request.buttonlist == null">
					<input type="submit"  id="czdsteponetijiao" lang="<s:property value="id"/>"    name="czdsteponetijiao" value="提交"></td>
					</s:if>
					<s:iterator value="#request.buttonlist" var="button">
						<s:if test="type==14104">
							<input type="button" class="oper" lang="${id }" buttonid="${button.id }" value="${button.name }" name="czdsteponetijiao" >
                		</s:if>
                	</s:iterator>
                </td>
					</tr>
				...
				$('.oper').click(function(){
				    ...
				    $("#productczdqtxx").attr("action","/productczdbase!submit.action");
		            $("#productczdqtxx").submit();
				})
//判断浏览器是不是ie  
var NV = {};
...
//对于ie浏览器版本为6,7,8的建议使用IE9.0以上版本，强烈建议使用chrome谷歌和360安全浏览器，火狐等常用浏览器
				...
				var zscqbox = $('.check');    
				var zscqnum = $('.num'); 
					zscqnum.css({'width':'50px','border':'0'});
					zscqbox.each(function(i,v){
						zscqbox.eq(i).change(function(){
				    		if(zscqbox.eq(i).is(":checked")){
				    			zscqnum.eq(i).attr('readonly',false).css({'color':'#333','border':"1px solid #e0e0e0"});
				    		}else{
