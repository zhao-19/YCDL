	...
	<div class="list fr">
		<div class="rightbox">
			...
			<div id="peixunhuodong" class="vipinfo" >
				...
				<form action="/productczdbase!updatestep1.action?e.id=${e.id}&e.t=${e.t}&taskid=${taskid}"  id="productczdbase" name="czdstepone" method="post">
				<table id="ycacti"  class="ycactifs zqrztable"  align="center" border="0" cellpadding="0" cellspacing="1">
					<tr>
					...
					<tr>
						...
						<input type="hidden" id="sqpzselect" value="<s:property value='e.daikuanpingz'/>"/>
							<select type="text"  id="e_daikuanpingz">
	 							...
	 							<option value="期权贷">期权贷</option>
	 							<option value="园保贷">园保贷</option>
	 						</select>
						</td>
 						</tr>
					...
					<tr>
 						...
 						<td  class="input"   colspan="3"><span class="spgap">主营：</span><input class="inputgap"   type="text" id="zhuyingyewu" name="zhuyingyewu"  value="<s:property value='e.zhuyingyewu'/>" style="width: 93% !important; float: right;"></td>
 						
					</tr>
					<tr>
						<td  class="input"   colspan="3"><span class="spgap">兼营：</span><input class="inputgap"   type="text" id="jianyingywu" name="jianyingywu"  value="<s:property value='e.jianyingywu'/>" style="width: 93% !important; float: right;"></td>
					</tr>
					<tr>
 						<td  >主营产品</td>
	   ...
	   <input class="rad"  type="radio" id="qiyexingzhi" name="qiyexingzhi" <%if ("aaaaaaaaaaaaaaaaaaaaaaaaaaaaa121".equals(request.getAttribute("e.qiyexingzhi"))) { out.print("checked=checked");} %> value="aaaaaaaaaaaaaaaaaaaaaaaaaaaaa121">民营企业&nbsp;&nbsp;&nbsp;
					...
					<tr>
 						<td colspan="4" class="tabletitle">员工构成</td>
					</tr>
					<tr>
 						<td  >员工总数</td>
					...
					<tr>
 						<td colspan="4" class="tabletitle">本期申请贷款情况</td>
					</tr>
					<tr>
 						<td  >申请贷款额度<br/>（万元）</td>
					...
					<tr>
 						<td  >贷款银行</td>
 						<td class="input tdtwo" id="daikuantd"  style="border:0;">
 						...
 						<select type="text" class="sdkyh"  id="szdd">
 							<option value="">-请选择-</option>
							<option value="盈创动力分配银行">盈创动力分配银行</option>
							<option value="邮储银行成都市太升南路支行">邮储银行成都市太升南路支行</option>
							<option value="邮储银行成都市高新支行">邮储银行成都市高新支行</option>
							<option value="邮储银行省分行直属支行">邮储银行省分行直属支行</option>
							<option value="邮储银行成都市沙湾支行">邮储银行成都市沙湾支行</option>
							<option value="邮储银行成都市双楠支行">邮储银行成都市双楠支行</option>
							<option value="建设银行成都第五支行">建设银行成都第五支行</option>
							<option value="工行高新支行">工行高新支行</option>
							<option value="工行双流支行">工行双流支行</option>
 						</select>
...
<script type="text/javascript"> //把贷款品种设置为禁止修改
	...
	if(daikuanpingzVal=='成长贷' || daikuanpingzVal=='壮大贷' || daikuanpingzVal=='期权贷'){
