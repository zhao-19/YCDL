...
logger.error("imgupload.jsp>>>>>");
SystemSetting systemSetting = SystemManager.systemSetting;
//文件保存目录路径
String savePath = pageContext.getServletContext().getRealPath("/") + "attached/upload/";
//String savePath = "D:\\workspace\\myshop\\web\\interestapp\\";//pageContext.getServletContext().getRealPath("/") + "interestapp/";
System.out.println(pageContext.getServletContext().getRealPath("/")+"attached/upload/");
//文件保存目录URL
//String saveUrl  = systemSetting.getImageRootPath()+"/interestapp/";//request.getContextPath() + "/interestapp/";
//String saveUrl  = systemSetting.getImagerootpath() +"/attached/upload/";
...
extMap.put("interestapp", "gif,jpg,jpeg,png,bmp");
...
if(true) {
	out.print("<img src=\"/image/index2.jpg\"  class=\"preview\">");
	logger.error("4test>>>>>upload file success :<img src=\"/image/index2.jpg\"  class=\"preview\">");
