    ...
    <style>
      ...
      <style>
       ...
       .zcKind li,.zcInRight li{float:left;}
        ...
        .zcKind li:nth-child(4){background-position: 0 -1550px;margin-bottom:0;}
        ...
        .right1>li{width:340px;}
        .right4>li{width:100%;}

        .right1>li:first-child{margin-right:45px;}
        .right1>li:nth-child(1){background-position: -464px 0;}
        .right1>li:nth-child(2){background-position: -855px 0;}
        .right4>li:nth-child(1){background-position: -464px -1550px;}
        ...
        .zcInRight .right4>li:nth-child(1) i{background-position:-1110px 0;}
...
<div class="ycdata_bgimg">
	<img src="<%=SystemManager.CONFIGS.get(Config.BANBENHAO_KEY) %>/image/banner/banner_sjbs.jpg" alt="背景图" style="height:200px;">
</div>
    ...
    <ol class="zcInRight fr ov">
        ...
        <li>
            <ul class="right3">
                <li>
                    <div class="zcMask"></div>
                    <a href="/userextend/getJrIndex.html" class="zcTxt">
                        <i></i>
                        <h2>高新区统计指标数据报送</h2>
                        <b class="hotImg"><img src="/icon/hot-tip.png" alt=""></b>
                    </a>
        ...
        <li>
            <ul class="right4">
                <li>
                    <div class="zcMask"></div>
                    <a href="/userextend/getFundInfo.html" class="zcTxt ifLogin" lang="3">
                        <i></i>
                        <h2>投资机构入库</h2>
                        <b class="hotImg"><img src="/icon/hot-tip.png" alt=""></b>
                    </a>
