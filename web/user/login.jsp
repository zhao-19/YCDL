		...
		<div class="bl new_lobg fr">
			<div class="lobg_nr">
				<form action="/user/doLogin.html" method="post" id="demoForm" autocomplete="off">
					...
					<p class="li telinp forgetinp"><span style="color:#f58357;margin-right:5px;"><s:property value="#session.errorMsg"/></span><span><a href="/user/forget.html">忘记密码</a>&nbsp;|&nbsp;</span><span><a href="/user/register.html">免费注册</a></span></p>
				</form>
			</div>
		</div>
	</div>
