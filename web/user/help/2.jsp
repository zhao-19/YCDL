...
<div class="bl helpbox">
    ...
    <ul class="helpNav">
        <li><a href="1.jsp">注册 <span>></span></a></li>
        <li class="active"><a href="2.jsp">登录 <span>></span></a></li>
    ...
    <div class="helpRight">
        <p><a href="/">首页</a> > <a href="#">帮助中心</a> > <b>登录</b></p>
        <div id="content">
           <div id="item1" class="item">
               <h2>
                   注册成功后，自动返回首页界面。已注册过的企业直接点击首页右上角登录，填写账户信息完成登录。
               </h2>
               <ul>
                   <li><img src="<%=SystemManager.CONFIGS.get(Config.BANBENHAO_KEY) %>/image/help/fenzhan/qy2.gif" alt=""/></li>
               </ul>
           </div>
       </div>
    </div>
