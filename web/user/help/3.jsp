...
<div class="bl helpbox">
    ...
    <ul class="helpNav">
        ...
        <li class="active"><a href="3.jsp">进入用户中心  <span>></span></a></li>
        <li><a href="4.jsp">用户中心首页  <span>></span></a></li>
        <li><a href="5.jsp">企业基本信息  <span>></span></a></li>
    </ul>
    </div>
    <div class="helpRight">
        <p><a href="/">首页</a> > <a href="#">帮助中心</a> > <b>进入用户中心</b></p>
        <div id="content">
           <div id="item1" class="item">
               <h2>
                   登录成功后，点击首页右上角账户名称，进入个人账户后台管理。
               </h2>
               <ul>
                   <li><img src="<%=SystemManager.CONFIGS.get(Config.BANBENHAO_KEY) %>/image/help/fenzhan/qy3.gif" alt=""/></li>
               </ul>
           </div>
       </div>
    </div>
