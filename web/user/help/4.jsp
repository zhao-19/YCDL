...
<div class="bl helpbox">
    ...
    <ul class="helpNav">
        ...
        <li class="active"><a href="4.jsp">用户中心首页  <span>></span></a></li>
        <li><a href="5.jsp">企业基本信息  <span>></span></a></li>
    </ul>
    </div>
    <div class="helpRight">
        <p><a href="/">首页</a> > <a href="#">帮助中心</a> > <b>用户中心首页</b></p>
        <div id="content">
           <div id="item1" class="item">
               <h2>
                   申请个业务之前，请关联企业并完善企业基本信息。
               </h2>
               <ul>
                   <li><img src="<%=SystemManager.CONFIGS.get(Config.BANBENHAO_KEY) %>/image/help/fenzhan/qy4.gif" alt=""/></li>
               </ul>
           </div>
       </div>
    </div>
