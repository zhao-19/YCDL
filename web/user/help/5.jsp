...
<div class="bl helpbox">
    ...
    <ul class="helpNav">
        ...
        <li class="active"><a href="5.jsp">企业基本信息  <span>></span></a></li>
    </ul>
    </div>
    <div class="helpRight">
        <p><a href="/">首页</a> > <a href="#">帮助中心</a> > <b>企业基本信息</b></p>
        <div id="content">
           <div id="item1" class="item">
               <h2>
                   点击左侧<企业信息>,填写企业基本情况后点<保存>（*为必填项）。
               </h2>
               <ul>
                   <li><img src="<%=SystemManager.CONFIGS.get(Config.BANBENHAO_KEY) %>/image/help/fenzhan/qy5.gif" alt=""/></li>
               </ul>
           </div>
       </div>
    </div>
